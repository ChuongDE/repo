...
<html lang="en">
    ...
    <body>
        <section class="h-100 h-custom" style="background-image: url(assets/IMG/FB-card-Dior-Sauvage_1.jpg);
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="checkout" method="post">
                                                                <button type="button" class="btn btn-primary">
                                                                    ...
                                                                    <input class="btn btn-lg btn-primary mt-2" type="submit" name="" value="Thanh Toán" />
                                                                </button>
                                                            </form>
                                                        </div>
                                                    </div>
