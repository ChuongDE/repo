                        ...
                        <tbody>
                            <c:forEach items="${listA}" var="o">
                                <tr>
                                    ...
                                    <td>${o.orderDate}</td>
                                    <td>
                                        <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${o.total}"/> VND
                                    </td>
                                    <td>
                                        <a href="show?oid=${o.orderID}" class="edit" data-toggle="modal"><span class="material-symbols-outlined">visibility</a>
                                    </td>
                                </tr>
                            </c:forEach>
